          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center pb-4 border-b border-gray-100">
              <div>
                ...
                <p className="text-sm text-gray-500">First {rules.baseDistanceKm} km</p>
              </div>
            ...
            <div className="flex justify-between items-center pb-4 border-b border-gray-100">
              <div>
                ...
                <p className="text-sm text-gray-500">After {rules.baseDistanceKm} km</p>
              </div>
              <span className="text-xl font-black text-gray-900">₹{rules.perKmRate}</span>
            </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-xl font-black text-gray-900">₹{rules.waitingChargePerMin}</span>
            </div>
          </div>
